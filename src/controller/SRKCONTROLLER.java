...
public class SRKCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.srkbong.getProductName());
        // price1.setText(Double.toString(LoginController.srkbong.getProductPrice()));
        // Image SRKIMAGE = new Image(LoginController.srkbong.getProductImage());
        // img1.setImage(SRKIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.srkbong.setProductStatus(true);
            LoginController.srkbong.setProductQuantity(1);
