...
public class TWCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.twbong.getProductName());
        // price1.setText(Double.toString(LoginController.twbong.getProductPrice()));
        // Image TWIMAGE = new Image(LoginController.twbong.getProductImage());
        // img1.setImage(TWIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.twbong.setProductStatus(true);
            LoginController.twbong.setProductQuantity(1);
