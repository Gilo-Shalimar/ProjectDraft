...
public class TXTCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.txtbong.getProductName());
        // price1.setText(Double.toString(LoginController.txtbong.getProductPrice()));
        // Image TXTIMAGE = new Image(LoginController.txtbong.getProductImage());
        // img1.setImage(TXTIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.txtbong.setProductStatus(true);
            LoginController.txtbong.setProductQuantity(1);
