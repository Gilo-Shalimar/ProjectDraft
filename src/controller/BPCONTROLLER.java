...
public class BPCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.bpbong.getProductName());
        // price1.setText(Double.toString(LoginController.bpbong.getProductPrice()));
        // Image BPIMAGE = new Image(LoginController.bpbong.getProductImage());
        // img1.setImage(BPIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.bpbong.setProductStatus(true);
            LoginController.bpbong.setProductQuantity(1);
