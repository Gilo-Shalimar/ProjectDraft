...
public class SVTCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.svtbong.getProductName());
        // price1.setText(Double.toString(LoginController.svtbong.getProductPrice()));
        // Image SVTIMAGE = new Image(LoginController.svtbong.getProductImage());
        // img1.setImage(SVTIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.svtbong.setProductStatus(true);
            LoginController.svtbong.setProductQuantity(1);
