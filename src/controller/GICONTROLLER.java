...
public class GICONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // name1.setText(LoginController.gibong.getProductName());
        // price1.setText(Double.toString(LoginController.gibong.getProductPrice()));
        // Image GIIMAGE = new Image(LoginController.gibong.getProductImage());
        // img1.setImage(GIIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.gibong.setProductStatus(true);
            LoginController.gibong.setProductQuantity(1);
