...
public class EXOCONTROLLER implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Image BTSIMAGE = new Image(LoginController.btsbong.getProductImage());
        // img1.setImage(BTSIMAGE);
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button2)) {
            LoginController.exobong.setProductStatus(true);
            LoginController.exobong.setProductQuantity(1);
    ...
    public void gotocart(ActionEvent event) throws IOException {
        ...
        //Scene scene = new Scene(new AnchorPane(rootPane.getChildren().toArray(new Node[0])));
